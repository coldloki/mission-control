      ...
      <div className="bg-white shadow rounded-lg border border-gray-100 overflow-hidden">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status/PID</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Service</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Port</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">CPU/Mem</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Auto</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Notes/Command</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {loading && processes.length === 0 ? (
              ...
              <tr><td colSpan={7} className="px-6 py-4 text-center text-sm text-gray-500">No processes match your filter.</td></tr>
            ) : (
              filtered.map((proc, i) => (
                <tr key={i} className={proc.pid === null ? "bg-gray-50" : ""}>
                  ...
                  <td className="px-6 py-4">
                    ...
                    <div className="text-xs font-mono text-gray-500 mb-0.5 truncate max-w-sm" title={proc.cwd}>{proc.cwd || "---"}</div>
                    <div className="text-[10px] text-gray-400 truncate max-w-sm" title={proc.command}>{proc.command}</div>
                  </td>
